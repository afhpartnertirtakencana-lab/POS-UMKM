...
const DEFAULT_DB = {
  settings: {
    storeName: "Budi Motor",
    address: "Jl. Rata No. 2a, Jakarta",
    phone: "0851-0000-8420",
    npwp: "",
    taxPercent: 0,
    logo: "",
  ...
  users: [
    { id: "u_owner", name: "Dewi", username: "owner", password: "owner123", role: "Owner", active: true },
    { id: "u_mgr", name: "Siti Aminah", username: "manager", password: "manager123", role: "Manager", active: true },
    { id: "u_kasir", name: "Yuli", username: "kasir", password: "kasir123", role: "Kasir", active: true },
